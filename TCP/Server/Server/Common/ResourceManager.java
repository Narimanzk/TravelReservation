...
public class ResourceManager
{
	...
	public boolean removeReservation(int xid, int customerID, String reserveditemKey, int count)  {
	...
	public int ItemsExist(int xid, String key, int count) {
		ReservableItem item = (ReservableItem)readData(xid, key);
		if (item == null){
			Trace.warn("RM::reserveItem(" + xid + ", " + key + ") failed as item doesn't exist");
			return -1;
		}
	...
	// Not using this one. Directly calling the RMs
