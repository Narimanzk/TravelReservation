...
public interface IResourceManager extends Remote 
{
     ...
     * @return Success
     */
    public boolean addCustomerID(int id, int cid)
        throws RemoteException;
     ...
     */
    public String queryCustomer(int id, int customerID) 
	throws RemoteException; 
     ...
     * @return Success
     */
    public boolean cancelReservation(int xid, int customerID, String key, int count)
            throws RemoteException;
    ...
    /**
     * items reserved and their price for a customer
     * 
     * @return Summary
     */
